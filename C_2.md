...
probability of a system being in a state with energy E is proportional to e^(-E/kT), where T is the temperature and k is
Boltzmann's constant. This relationship, known as the Boltzmann distribution, inspired the acceptance probability
function used in the algorithm.

<div align="center"> <img src="images/Artificial_Intelligence_ND_P3_C2_01.png" width="600" height="auto"> <p style="color: #555;">Figure: Simulated annealing can escape local optima by occasionally accepting worse solutions</p> </div>
...
<div align="center"> <img src="images/Artificial_Intelligence_ND_P3_C2_02.png" width="600" height="auto"> <p style="color: #555;">Figure: Visualization of a genetic algorithm population evolving over time</p> </div>
...
queens, there are 28 possible pairs (calculated as n(n-1)/2 = 8×7/2 = 28), so the maximum fitness is 28, representing a
solution where no queens attack each other.

<div align="center"> <img src="images/Artificial_Intelligence_ND_P3_C2_03.png" width="600" height="auto"> <p style="color: #555;">Figure: Example of fitness evaluation in genetic algorithms</p> </div>
...
1. **Fitness-Proportionate Selection (Roulette Wheel Selection)**: Each individual's probability of selection is
   ...
   of being selected.
    ...
    Where 78 is the sum of all fitness values. This method can be visualized as a roulette wheel where each individual
...
<div align="center"> <img src="images/Artificial_Intelligence_ND_P3_C2_04.png" width="600" height="auto"> <p style="color: #555;">Figure: Selection process in genetic algorithms</p> </div>
