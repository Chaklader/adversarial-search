...
function used in the algorithm. The following psudo-code returns a solution state inputs: problem, a problem schedule, a
mapping from time to "temperature" provided below:
...
While the pseudocode shows an infinite loop with termination when T=0, practical implementations typically use a finite
number of iterations or additional stopping criteria.
