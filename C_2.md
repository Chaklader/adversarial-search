...
```mermaid
flowchart TD
    %% Main process flow with colors
    style Start fill:#C6F486,stroke:#333,color:#333
    style Selection fill:#9EE3FF,stroke:#333,color:#333
    style Crossover fill:#D8BBFF,stroke:#333,color:#333
    style Mutation fill:#FFFFB5,stroke:#333,color:#333
    style Evaluation fill:#FFD6A5,stroke:#333,color:#333
    style Decision fill:#CAFAC8,stroke:#333,color:#333
    style End fill:#FFABAB,stroke:#333,color:#333

    Start["Initial Population"] --> Selection
    Selection --> Crossover
    Crossover --> Mutation
    Mutation --> Evaluation
    Evaluation --> Decision
    Decision -->|Solution Found| End["Return Solution"]
    Decision -->|Continue| Selection


%% Detailed boxes for Selection Process
subgraph "Selection Process"
    style Selection fill:#9EE3FF,stroke:#333,color:#333
    style SelectionBox1 fill:#9EE3FF,stroke:#333,color:#333
    style SelectionBox2 fill:#9EE3FF,stroke:#333,color:#333
    style SelectionBox3 fill:#9EE3FF,stroke:#333,color:#333


    Selection["Selection"]
    SelectionBox1["Calculate Fitness Scores"]
    SelectionBox2["Assign Selection Probabilities"]
    SelectionBox3["Choose Parents Based on Fitness"]

    Selection --> SelectionBox1
    SelectionBox1 --> SelectionBox2
    SelectionBox2 --> SelectionBox3

end

%% Detailed boxes for Crossover Process
subgraph "Crossover Process"
    style Crossover fill:#D8BBFF,stroke:#333,color:#333
    style CrossoverBox1 fill:#D8BBFF,stroke:#333,color:#333
    style CrossoverBox2 fill:#D8BBFF,stroke:#333,color:#333
    style CrossoverBox3 fill:#D8BBFF,stroke:#333,color:#333
    style CrossoverBox4 fill:#D8BBFF,stroke:#333,color:#333


    Crossover["Crossover"]
    CrossoverBox1["Pair Selected Parents"]
    CrossoverBox2["Choose Random Crossover Points"]
    CrossoverBox3["Exchange Genetic Material"]
    CrossoverBox4["Create New Offspring"]

    Crossover --> CrossoverBox1
    CrossoverBox1 --> CrossoverBox2
    CrossoverBox2 --> CrossoverBox3
    CrossoverBox3 --> CrossoverBox4

end

%% Detailed boxes for Mutation Process
subgraph "Mutation Process"
    style Mutation fill:#FFFFB5,stroke:#333,color:#333
    style MutationBox1 fill:#FFFFB5,stroke:#333,color:#333
    style MutationBox2 fill:#FFFFB5,stroke:#333,color:#333
    style MutationBox3 fill:#FFFFB5,stroke:#333,color:#333


    Mutation["Mutation"]
    MutationBox1["For Each Position in Each Offspring"]
    MutationBox2["Generate Random Number"]
    MutationBox3["If Number < Mutation Rate, Change Value"]

    Mutation --> MutationBox1
    MutationBox1 --> MutationBox2
    MutationBox2 --> MutationBox3

end

%% Detailed boxes for Evaluation Process
subgraph "Evaluation Process"
    style Evaluation fill:#FFD6A5,stroke:#333,color:#333
    style EvaluationBox1 fill:#FFD6A5,stroke:#333,color:#333
    style EvaluationBox2 fill:#FFD6A5,stroke:#333,color:#333
    style EvaluationBox3 fill:#FFD6A5,stroke:#333,color:#333


    Evaluation["Evaluation"]
    EvaluationBox1["Calculate Fitness of New Population"]
    EvaluationBox2["Compare with Previous Generation"]
    EvaluationBox3["Track Best Solution So Far"]

    Evaluation --> EvaluationBox1
    EvaluationBox1 --> EvaluationBox2
...
###### Genetic Algorithm Flow for Solving the 8-Queens Problem

I'll create diagrams that illustrate how genetic algorithms solve the 8-Queens problem, breaking each component into its
own subgraph for clarity.
...
flowchart TD
    ...
    subgraph sg1 ["Initialize Population"]
        style sg1 fill:#E8FC8C,stroke:#7bb8d8
        style A1 fill:#C6F486,stroke:#333,color:#333
        style A2 fill:#C6F486,stroke:#333,color:#333
        style A3 fill:#C6F486,stroke:#333,color:#333

        A1["Generate 100-200 random permutations of digits 1-8"] --> A2["Each permutation = queen positions by column"]
        A2 --> A3["Example: '24748552' means queen in column 1 is at row 2, etc."]
    end

style A fill:#9EE3FF,stroke:#333,color:#333
style B fill:#9EE3FF,stroke:#333,color:#333
style C fill:#FFD6A5,stroke:#333,color:#333
style D fill:#FFABAB,stroke:#333,color:#333
style E fill:#CAFAC8,stroke:#333,color:#333
style F fill:#D8BBFF,stroke:#333,color:#333
style G fill:#FFFFB5,stroke:#333,color:#333


style sg1 fill:#C6F486,stroke:#333,color:#333
style A1 fill:#9EE3FF,stroke:#333,color:#333
style A2 fill:#FFD6A5,stroke:#333,color:#333
style A3 fill:#FFABAB,stroke:#333,color:#333
```
...
subgraph "Evaluate Fitness"
    B1["Count non-attacking queen pairs"] --> B2["Maximum possible pairs: 28"]
    B2 --> B3["Check for row conflicts"]
    B3 --> B4["Check for diagonal conflicts"]
    B4 --> B5["Fitness = number of non-attacking pairs"]
end

style B1 fill:#C6F486,stroke:#333,color:#333
style B2 fill:#9EE3FF,stroke:#333,color:#333
style B3 fill:#FFD6A5,stroke:#333,color:#333
style B4 fill:#FFABAB,stroke:#333,color:#333
style E fill:#CAFAC8,stroke:#333,color:#333
style F fill:#D8BBFF,stroke:#333,color:#333
style G fill:#FFFFB5,stroke:#333,color:#333
...
subgraph "Selection"
    E1["Higher fitness = higher selection probability"] --> E2["Example: Fitness 24 is 20% more likely to be selected than fitness 20"]
    E2 --> E3["Keep small number of best solutions unchanged 'Elitism'"]
end

style A fill:#C6F486,stroke:#333,color:#333
style B fill:#9EE3FF,stroke:#333,color:#333
style C fill:#FFD6A5,stroke:#333,color:#333
style D fill:#FFABAB,stroke:#333,color:#333
style E fill:#CAFAC8,stroke:#333,color:#333
...
style E1 fill:#C6F486,stroke:#333,color:#333
style E2 fill:#9EE3FF,stroke:#333,color:#333
```
...
flowchart TD
    ...
    G --> B
subgraph "Crossover"
    F1["Select two parent solutions"] --> F2["Choose random crossover point"]
    F2 --> F3["Parent1: '24748552' split at position 3 = '247' + '48552'"]
    F3 --> F4["Parent2: '32752411' split at position 3 = '327' + '52411'"]
    F4 --> F5["Child1: '24752411'"]
    F3 --> F6["Child2: '32748552'"]
    F5 --> F7["Repair any invalid solutions"]
    F6 --> F7
end
...
style F1 fill:#C6F486,stroke:#333,color:#333
style F2 fill:#9EE3FF,stroke:#333,color:#333
style F3 fill:#FFD6A5,stroke:#333,color:#333
style F4 fill:#FFABAB,stroke:#333,color:#333
style F5 fill:#CAFAC8,stroke:#333,color:#333
style F6 fill:#D8BBFF,stroke:#333,color:#333
style F7 fill:#FFFFB5,stroke:#333,color:#333
```
...
subgraph "Mutation"
    G1["Low probability operation"] --> G2["Typically swap two random positions"]
    G2 --> G3["Example: '24752411' mutates to '24152471'"]
    G3 --> G4["Maintains diversity and avoids local optima"]
end
...
style G1 fill:#C6F486,stroke:#333,color:#333
style G2 fill:#9EE3FF,stroke:#333,color:#333
style G3 fill:#FFD6A5,stroke:#333,color:#333
```

Now I'll illustrate the evolution process over multiple generations, with each generation as its own subgraph:
...
subgraph "Generation 0"
    ...
    Gen0_1["Solution 1: Fitness 20"]
    Gen0_2["Solution 2: Fitness 22"]
    Gen0_3["Solution 3: Fitness 19"]
    Gen0_4["Solution 4: Fitness 23"]
    Gen0_Best["Best Fitness: 23/28"]
    Gen0_Avg["Average Fitness: 21/28"]
...
style G fill:#FFFFB5,stroke:#333,color:#333
 ...
 style Gen0 fill:#C6F486,stroke:#333,color:#333
 style Gen0_1 fill:#9EE3FF,stroke:#333,color:#333
 style Gen0_2 fill:#9EE3FF,stroke:#333,color:#333
 style Gen0_3 fill:#9EE3FF,stroke:#333,color:#333
 style Gen0_4 fill:#9EE3FF,stroke:#333,color:#333
 style Gen0_Best fill:#FFD6A5,stroke:#333,color:#333
 style Gen0_Avg fill:#CAFAC8,stroke:#333,color:#333
...
subgraph "Generation 10"
    Gen10["Early Evolution"]
    Gen10_1["Solution 1: Fitness 23"]
    Gen10_2["Solution 2: Fitness 24"]
    Gen10_3["Solution 3: Fitness 25"]
    Gen10_4["Solution 4: Fitness 24"]
    Gen10_Best["Best Fitness: 25/28"]
    Gen10_Avg["Average Fitness: 24/28"]
...
style Gen10 fill:#C6F486,stroke:#333,color:#333
style Gen10_1 fill:#9EE3FF,stroke:#333,color:#333
style Gen10_2 fill:#9EE3FF,stroke:#333,color:#333
style Gen10_3 fill:#9EE3FF,stroke:#333,color:#333
style Gen10_4 fill:#9EE3FF,stroke:#333,color:#333
style Gen10_Best fill:#FFD6A5,stroke:#333,color:#333
style Gen10_Avg fill:#CAFAC8,stroke:#333,color:#333
...
subgraph "Generation 30"
    Gen30["Middle Evolution"]
    Gen30_1["Solution 1: Fitness 26"]
    Gen30_2["Solution 2: Fitness 27"]
    Gen30_3["Solution 3: Fitness 25"]
    Gen30_4["Solution 4: Fitness 26"]
    Gen30_Best["Best Fitness: 27/28"]
    Gen30_Avg["Average Fitness: 26/28"]
...
style Gen30 fill:#C6F486,stroke:#333,color:#333
style Gen30_1 fill:#9EE3FF,stroke:#333,color:#333
style Gen30_2 fill:#9EE3FF,stroke:#333,color:#333
style Gen30_3 fill:#9EE3FF,stroke:#333,color:#333
style Gen30_4 fill:#9EE3FF,stroke:#333,color:#333
style Gen30_Best fill:#FFD6A5,stroke:#333,color:#333
style Gen30_Avg fill:#CAFAC8,stroke:#333,color:#333
```
...
subgraph "Generation 50"
    Gen50["Final Evolution"]
    Gen50_1["Solution 1: Fitness 28"]
    Gen50_2["Solution 2: Fitness 27"]
    Gen50_3["Solution 3: Fitness 28"]
    Gen50_4["Solution 4: Fitness 27"]
    Gen50_Best["Best Fitness: 28/28"]
    Gen50_Avg["Average Fitness: 27/28"]
    Gen50_Sol["Solution Found: '15863724'"]
...
style Gen50 fill:#C6F486,stroke:#333,color:#333
style Gen50_1 fill:#9EE3FF,stroke:#333,color:#333
style Gen50_2 fill:#9EE3FF,stroke:#333,color:#333
style Gen50_3 fill:#9EE3FF,stroke:#333,color:#333
style Gen50_4 fill:#9EE3FF,stroke:#333,color:#333
style Gen50_Best fill:#FFD6A5,stroke:#333,color:#333
style Gen50_Avg fill:#CAFAC8,stroke:#333,color:#333
```
...
graph TD
    Gen0["Generation 0"] --> Gen10["Generation 10"]
    Gen10 --> Gen30["Generation 30"]
    Gen30 --> Gen50["Generation 50"]

style Gen0 fill:#C6F486,stroke:#333,color:#333
style Gen10 fill:#9EE3FF,stroke:#333,color:#333
style Gen30 fill:#E8FC8C,stroke:#333,color:#333
style Gen50 fill:#FF5F2D,stroke:#333,color:#333

```

To make the encoding more concrete, here's how a solution like "15863724" translates to a valid 8-Queens board
arrangement:
...
The genetic algorithm for solving the 8-Queens problem works through several interconnected processes:

1. **Representation**: Each potential solution is encoded as a string of 8 digits (like "15863724"), where each position
   represents a column and the digit value represents the row where a queen is placed in that column.
2. **Fitness Evaluation**: We calculate how good each solution is by counting how many pairs of queens don't attack each
   other. With 8 queens, there are 28 possible pairs (8×7÷2). A perfect solution has all 28 pairs non-attacking.
3. **Selection**: Solutions with higher fitness values have a better chance of being selected to produce the next
   generation. This mimics natural selection, where better-adapted individuals are more likely to reproduce.
4. **Crossover**: Selected parent solutions exchange genetic material. For example, we might take the first three
   positions from one parent and the remaining five from another to create a new offspring solution.
5. **Mutation**: Occasionally, random changes are introduced to maintain genetic diversity. In the 8-Queens context,
   this typically involves swapping the positions of two queens.

As the algorithm runs through multiple generations, the average fitness of the population increases, eventually
converging on a solution where no queen threatens any other queen. The process demonstrates how evolutionary principles
can be applied to solve complex problems through gradual improvement and exploration of the solution space.
...
flowchart LR
    ...
    subgraph "Initial Population"
        style Pop1 fill:#FFFFFF,stroke:#333,color:#333
        style Pop2 fill:#FFFFFF,stroke:#333,color:#333
        style Pop3 fill:#FFFFFF,stroke:#333,color:#333
        style Pop4 fill:#FFFFFF,stroke:#333,color:#333
        style F1 fill:#FFFFFF,stroke:none,color:#FF0000
        style F2 fill:#FFFFFF,stroke:none,color:#FF0000
        style F3 fill:#FFFFFF,stroke:none,color:#FF0000
        style F4 fill:#FFFFFF,stroke:none,color:#FF0000
        style P1 fill:#FFFFFF,stroke:none,color:#7B68EE
        style P2 fill:#FFFFFF,stroke:none,color:#7B68EE
        style P3 fill:#FFFFFF,stroke:none,color:#7B68EE
        style P4 fill:#FFFFFF,stroke:none,color:#7B68EE
...
subgraph "Selection & Crossover"
    style S1 fill:#ADD8E6,stroke:#333,color:#333
    style S2 fill:#FFFF99,stroke:#333,color:#333
    style S3 fill:#ADD8E6,stroke:#333,color:#333
    style S4 fill:#FFFF99,stroke:#333,color:#333
...
%% Recombined
subgraph "Recombined Offspring"
    style R1 fill:#ADD8E6,stroke:#333,color:#333
    style R2 fill:#FFFF99,stroke:#333,color:#333
    style R3 fill:#ADD8E6,stroke:#333,color:#333
    style R4 fill:#FFFF99,stroke:#333,color:#333
...
subgraph "After Mutation"
    style M1 fill:#FFFFFF,stroke:#333,color:#333
    style M2 fill:#FFFFFF,stroke:#333,color:#333
    style M3 fill:#FFFFFF,stroke:#333,color:#333
    style M4 fill:#FFFFFF,stroke:#333,color:#333
    style Mut1 fill:#FFFFFF,stroke:none,color:#FF0000
    style Mut2 fill:#FFFFFF,stroke:none,color:#FF0000
    style Mut3 fill:#FFFFFF,stroke:none,color:#FF0000
...
%% Flow connections between main sections
Pop1 --> S1
Pop2 --> S2
Pop3 --> S3
Pop4 --> S4
...
In the Initial Population section, we have four candidate solutions to the 8-Queens problem, each represented as a
string of 8 digits (like "24748552"). Each solution has a fitness score shown in red (24, 23, 20, and 11), which
reflects how many pairs of queens are non-attacking. Based on these fitness values, each solution has a selection
probability (31%, 29%, 26%, and 14%) shown in purple.

The Selection & Crossover section shows how parents are selected and paired based on their fitness scores. The vertical
dotted line represents the crossover point (after the 4th position). The algorithm splits each parent string at this
point and recombines them to create new offspring.

The Recombined Offspring section shows the results after crossover. For example, the first offspring "32748552" takes
the first 4 digits from the first selected parent "3275" and the last 4 digits from another parent "8552". This process
creates new combinations of queen arrangements that potentially have better fitness than their parents.

The After Mutation section shows the final solutions after random mutations are applied. The red digits highlight where
mutations occurred. For instance, in the first offspring, the 5th digit changed from 5 to 1, creating "32748152". These
mutations help maintain genetic diversity and allow the algorithm to explore new areas of the solution space.

Through this process of selection, crossover, and mutation repeated over many generations, the genetic algorithm
gradually improves the quality of solutions until it finds an arrangement where no queens threaten each other (fitness
28/28).
...
- Total non-attacking pairs: 24 (= 28-4)
- Fitness value: 24
...
Mutation is a critical component of genetic algorithms that helps maintain diversity in the population and prevents
premature convergence to suboptimal solutions. Think of it as introducing small, random variations that allow the
algorithm to explore new possibilities that might not be accessible through crossover alone.

In the context of the 8-Queens problem, mutation operates by randomly altering one or more positions in a solution
string with a relatively low probability (typically around 1-5% per position). This randomness serves a purpose similar
to biological mutations in natural evolution—it introduces novel genetic material that wasn't present in the parents.

After crossover produces the child solution "24752411", the mutation operator examines each position in this string one
by one. For each position, it generates a random number and compares it to the mutation probability (let's say 5% or
0.05). If the random number is less than 0.05, that position mutates to a new random value; otherwise, it remains
unchanged.

In our example, position 5 was randomly selected for mutation, and the value changed from 5 to 1:

- Before mutation: "24752411"
- After mutation: "24712411"

This may seem like a small change, but it can have significant effects on the solution's fitness, especially in problems
like 8-Queens where changing one queen's position affects multiple attacking relationships.

Mutation serves several essential functions in genetic algorithms:

1. **Maintaining genetic diversity**: Without mutation, the population would eventually converge to combinations of the
   genetic material present in the initial population. Mutation introduces new possibilities that weren't initially
   available.
2. **Escaping local optima**: When the population converges toward a locally optimal but globally suboptimal solution,
   crossover alone might not be able to escape this local optimum because it just recombines existing material. Mutation
   can introduce the variations needed to explore new regions of the search space.
3. **Fine-tuning solutions**: Small mutations can sometimes lead to incremental improvements in already good solutions,
   helping to refine them further.
4. **Preventing premature convergence**: Without mutation, the population might quickly converge to similar solutions,
   losing the diversity needed for effective search.

The mutation rate requires careful balancing. If it's too high, the algorithm becomes more like random search,
discarding the benefits of selection and crossover. If it's too low, the population might lose diversity and get trapped
in local optima.

In the 8-Queens example, mutation might change a queen's position in a way that resolves an attacking relationship that
couldn't be fixed through crossover alone. This highlights how mutation complements the other genetic operators to
create a robust search mechanism that can effectively navigate complex solution spaces.
...
In many optimization problems, particularly those involving well-defined mathematical functions, we can calculate
derivatives (gradients) that tell us the direction of steepest ascent or descent. This gradient information is powerful
because it shows us the most efficient direction to move to improve our solution. Popular algorithms like gradient
descent rely entirely on this information.

However, there are several important situations where gradients are unavailable:

1. **Black box functions**: When the objective function is essentially a "black box" — perhaps it's a complex
   simulation, a physical experiment, or legacy software where we can only observe inputs and outputs but can't see the
   internal workings.
2. **Non-differentiable functions**: Some functions have discontinuities or sharp corners where derivatives don't exist.
   For example, functions with step changes or discrete components.
3. **Noisy evaluations**: When function evaluations contain random noise or measurement errors, the estimated gradients
   can be highly unreliable and might lead optimization algorithms astray.
4. **Computationally expensive gradients**: Sometimes calculating the gradient might require multiple function
   evaluations (like in finite difference approximation), making it impractically expensive when each function
   evaluation is costly.
5. **Discrete optimization problems**: When variables can only take discrete values, the notion of gradients becomes
   unclear.

The genetic algorithm we've been discussing for the 8-Queens problem is actually a perfect example of derivative-free
optimization. There's no meaningful gradient to follow because:

- The problem involves discrete placements of queens
- The fitness function (counting non-attacking queen pairs) doesn't have a continuous derivative
- Small changes in queen placement can cause abrupt changes in fitness

Other derivative-free methods include:
...
These approaches use various strategies—random sampling, population evolution, surrogate modeling, or pattern search—to
intelligently explore the solution space without requiring gradient information.
