...
The algorithms we'll focus on initially, like minimax, are designed for two-player, zero-sum, perfect information games.
These form the foundation for understanding more complex adversarial search techniques that can handle imperfect
